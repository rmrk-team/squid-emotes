module.exports = class Data1688650123467 {
    name = 'Data1688650123467'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "emotes" ("id" character varying NOT NULL, "emoter" text NOT NULL, "collection" text NOT NULL, "token_id" numeric NOT NULL, "emoji" text NOT NULL, "on" boolean NOT NULL, "block_id" character varying, CONSTRAINT "PK_cb6e5f698047510ae02455a74fc" PRIMARY KEY ("id"))`)
