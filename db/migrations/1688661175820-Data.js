module.exports = class Data1688661175820 {
    name = 'Data1688661175820'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "token_emote" ("id" character varying NOT NULL, "emoji" text NOT NULL, "on" boolean NOT NULL, "chain_id" integer NOT NULL, "token_id" character varying, "emoter_id" character varying, CONSTRAINT "PK_a17925944b39ca615cf9d5b62e3" PRIMARY KEY ("id"))`)
